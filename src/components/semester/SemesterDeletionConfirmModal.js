...
const SemesterDeletionConfirmModal = (props) => {
  const { semester, operation } = props;
...
export default SemesterDeletionConfirmModal;

SemesterDeletionConfirmModal.propTypes = {
